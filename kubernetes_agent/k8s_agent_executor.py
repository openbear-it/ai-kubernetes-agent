...
class k8sAgentExecutor(AgentExecutor):
    ...
    STEP_TIMEOUT = 120  # Maximum time allowed for a single step (seconds)
    SLOW_STEP_THRESHOLD = 30  # Time threshold to mark a step as slow (seconds)
    MAX_TOTAL_TIME = 300  # Maximum total execution time (seconds)
